  ...
  return (
    <div className='container-fluid d-f fd-column align-items-center' style={{height:"70vh"}}>
      ...
      <div className={responsive ? 'w-30 d-f justify-content-sb' : 'w-60 d-f fd-column align-items-center g-3'}>
        <button  className={responsive ? ' ageButton fs-lg' : 'ageButtonRes fs-md'} onClick={()=>navigate("/courses")}>3-7</button>
        <button className={responsive ? ' ageButton fs-lg' : 'ageButtonRes fs-md'} onClick={()=>navigate("/leveltest/forfirst")}>7-14</button>
        <button className={responsive ? ' ageButton fs-lg' : 'ageButtonRes fs-md'}
        onClick={()=>navigate("/leveltest/forsecond")}
        >14+</button>
      </div>
    </div>
  )
