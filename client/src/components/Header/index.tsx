...
console.log(username);
  ...
  const closeMenu = () => {
    setMenuOpen(false);
    document.body.classList.remove("menu-open"); // Gri arka planı kaldır
  };
  return (
    <div
      style={{
    ...
    >
      ...
      >
        <div className="d-none d-sm-flex">
          <img src={menu} alt="hamburger menu"  onClick={toggleMenu} />
        </div>
        <nav className={menuOpen ? "open nav " : "d-none"}>
